...
export function ClientsSection({ title, subtitle, clients }: ClientsSectionProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative w-full h-full grayscale group-hover:grayscale-0 transition-all duration-500 z-10">
                      ...
                      <Image
                        ...
                        className={`object-contain ${
                          client.name === "SBR Repuestos" || client.name === "Espacio Wilde" 
                            ? "rounded-full" 
                            : ""
                        }`}
        ...
        <div className="text-center mt-8">
          <p className="text-white/80 text-sm">
            Y muchas más organizaciones que confían en nosotros
          </p>
        </div>
      </div>
    </section>
