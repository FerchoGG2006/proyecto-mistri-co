        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-secondary">tu Organización?</span>
            </h1>
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Agenda una consulta gratuita y descubre cómo podemos ayudarte a
              desarrollar líderes efectivos, optimizar procesos y alcanzar tus
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-medium-gray">
                        Más de 10 años transformando organizaciones en Argentina
                        y la región.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-medium-gray">
                        Profesionales especializados en cada área de tu
                        organización.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-medium-gray">
                        Metodologías probadas que generan impacto real y
                        sostenible.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-medium-gray">
                        Soporte permanente para el crecimiento sostenible de tu
                        organización.
                      </p>
                    </div>
                  </div>
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-medium-gray">
                    Nuestro equipo revisa cada consulta personalmente y te
                    brinda una respuesta detallada con las mejores opciones para
                    tu organización.
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-[#83e935] text-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Llámanos ahora y habla directamente con uno de nuestros
            especialistas
          </p>
